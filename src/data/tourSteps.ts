...
export const TOUR_STEPS: Record<string, TourStep[]> = {
  ...
  // Tour da tela Boards (lista): apresenta a lista e a CRIAÇÃO de um board.
  // As trilhas de dentro do board (Daily, Encerrar sprint, trocar visão) são
  // separadas — ficam em EXTRA_TOURS['boards-list'], sob demanda.
  'boards-list': [
    {
      selector: '[data-tour="board-status"]',
      placement: 'bottom',
      title: 'Seus boards',
      body: 'Cada board é uma visão do projeto em colunas — um projeto pode ter vários. Aqui você lista todos, busca pelo nome/projeto e filtra por Ativos, Arquivados ou Todos.',
    },
    {
      selector: '[data-tour="board-new"]',
      placement: 'bottom',
      title: 'Criar um board',
      body: 'Boards adicionais são visões filtradas do mesmo projeto (ex.: por squad, só bugs, por componente). Vamos abrir o formulário. (O tour abre para você.)',
      clickOnNext: '[data-tour="board-new"]',
    },
    {
      selector: '[data-tour="nb-name"]',
      placement: 'right',
      title: 'Nome do board',
      body: 'Como o board será identificado (ex.: "Sprint Bugs", "Kanban Design"). Havendo mais de um projeto, escolha o projeto logo acima.',
    },
    {
    ...
    {
      selector: '[data-tour="nb-filter"]',
      placement: 'right',
      title: 'Filtro do board',
      body: 'Opcional: define quais itens do projeto aparecem neste board (responsável, prioridade, tipo, sprint, épico…). É o que o torna uma "visão".',
      optional: true,
    },
    {
      selector: '[data-tour="nb-save"]',
      placement: 'top',
      title: 'Criar',
      body: 'Revise e clique em "Criar board". (O tour não cria por você.)',
      optional: true,
    },
  ],
  ...
  storage: [
    ...
    { selector: '[data-tour="st-plan"]', placement: 'left', title: 'Plano e upgrade', body: 'A etiqueta mostra o plano de armazenamento atual (ex.: "free"). Vamos abrir os planos: clique em "Fazer upgrade". (O tour abre para você; disponível para quem pode gerenciar o plano.)', clickOnNext: '[data-tour="st-upgrade"]', optional: true },
    { selector: '[data-tour="sp-current"]', placement: 'bottom', title: 'Plano atual e cota', body: 'No topo do painel: o plano vigente e a "Cota efetiva" — o espaço total disponível hoje (plano base + pacotes já aprovados). Nenhuma cobrança é feita aqui; toda escolha vira uma solicitação para análise.', optional: true },
    { selector: '[data-tour="sp-plans"]', placement: 'bottom', title: 'Planos base', body: 'Dois planos de conta: Free (1 GB, incluso em todas as contas) e Pago (25 GB, mais espaço para os anexos do time). "Solicitar" registra o pedido; sem permissão, aparece "Solicite ao gestor".', optional: true },
    { selector: '[data-tour="sp-billing"]', placement: 'bottom', title: 'Pacotes e cobrança', body: 'Pacotes extras de GB, somados ao plano. Alterne entre Mensal e Anual — o anual sai com ≈2 meses grátis.', optional: true },
    { selector: '[data-tour="sp-packs"]', placement: 'top', title: 'Pacotes de GB', body: 'Pacotes de +10, +25, +50 e +100 GB, cada um com o preço no ciclo escolhido (mensal ou anual). "Solicitar" registra o pedido de ampliação para o gestor aprovar — nada é cobrado automaticamente.', optional: true },
  ],
