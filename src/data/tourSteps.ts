...
export const TOUR_STEPS: Record<string, TourStep[]> = {
  ...
  storage: [
    ...
    { selector: '[data-tour="sp-current"]', placement: 'bottom', title: 'Plano atual e cota', body: 'No topo do painel: o plano vigente e a "Cota efetiva" — o espaço total disponível hoje (plano base + add-ons já aprovados). Nenhuma cobrança é feita aqui; toda escolha vira uma solicitação para análise.', optional: true },
    ...
    { selector: '[data-tour="sp-billing"]', placement: 'bottom', title: 'Add-ons e cobrança', body: 'Pacotes extras de GB, somados ao plano. Alterne entre Mensal e Anual — o anual sai com ≈2 meses grátis.', optional: true },
    { selector: '[data-tour="sp-packs"]', placement: 'top', title: 'Pacotes de GB', body: 'Add-ons de +10, +25, +50 e +100 GB, cada um com o preço no ciclo escolhido (mensal ou anual). "Solicitar" registra o pedido de ampliação para o gestor aprovar — nada é cobrado automaticamente.', optional: true },
  ],
