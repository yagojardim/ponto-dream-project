...
export const ONBOARDING_TIPS: Record<string, OnboardingTip> = {
  ...
  calendar: {
    ...
    guide: [
      ...
      { heading: 'Criar evento', text: 'Em "+ Criar" você registra um evento novo. Obrigatório é só o título; o tipo (Reunião, Daily, Planning…) já define a cor. Depois vêm o período (dia inteiro ou data + horário de início/fim), os convidados e o link de videochamada. Use "Mais opções" para abrir os campos avançados: local, descrição, cor, vínculo com uma demanda (work item) e lembrete.', image: '/help/calendario--criar-mais-opcoes.png', imageAlt: 'Criação de evento com mais opções' },
